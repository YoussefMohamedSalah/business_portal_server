...
import { getAllInvoicesByProject } from "../controller/SubcontractorInvoiceController";
...
router.route("/subcontractor_invoice/:projectId").get(checkAuth, getAllInvoicesByProject);
